...
* Ship status script will record the health status of each ship, when ship was hit by laser or rocket, health decrease, if health derease to 0, it will install a explosion object and debris will be spawned whether its part of ship or some pices
